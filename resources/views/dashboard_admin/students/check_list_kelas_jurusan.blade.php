...
@section('br-mainpanel')
    ...
    <div class="br-pageheader">
        <nav class="breadcru pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Check List Kelas Jurusan</span>
        </nav>
    </div><!-- br-pageheader -->
    ...
    <div class="br-pagetitle">
        ...
        <div>
            <h4>Check List Kelas Jurusan</h4>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            {{-- <p class="br-section-text">Note* : Pilih Siswa (*) Untuk memilih satu persatu, gunakan Ctrl+Klik, Untuk memilih Semua gunakan Ctrl+A</p> --}}
                ...
                <div class="col-12 grid-margin">                
                        <form class="form-sample" action="{{route('check-list-kelas-jurusan-action')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="diterima_pada_tanggal" class="form-control" id=""  placeholder="" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="">JURUSAN SEKARANG</label>
                                        <input type="text" name="" class="form-control" id="sekarang_jurusan_id"  placeholder="Otomatis Terisi" readonly>
